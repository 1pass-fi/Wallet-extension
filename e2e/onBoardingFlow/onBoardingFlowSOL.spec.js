...
describe('e2e test', () => {
  ...
  it('test create new solana wallet', async () => {
    ...
    const keyLogoButton = await optionPage.waitForSelector('[data-testid="solana-key"]')
  ...
  it('verify the account address', async () => {
    ...
    await Automation.importWallet(optionPage, TYPE.SOLANA, savePhrases.join(' '))
