...
const NFTCard = ({ nft }) => {
  ...
  return (
    ...
    >
      <div className="w-full h-full absolute top-0 left-0 flex flex-col items-center justify-center z-30 rounded hover:bg-warmGray hover:bg-opacity-80 opacity-0 hover:opacity-100">
