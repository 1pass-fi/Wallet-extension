...
export default async () => {
  const messageTypes = [
    ...
    MESSAGES.K2_SIGN_MESSAGE_SUCCESS,
    MESSAGES.K2_SIGN_MESSAGE_ERROR,
    MESSAGES.K2_SIGN_TRANSACTION_SUCCESS,
    MESSAGES.K2_SIGN_TRANSACTION_ERROR,
    MESSAGES.K2_SIGN_AND_SEND_TRANSACTION_SUCCESS,
    MESSAGES.K2_SIGN_AND_SEND_TRANSACTION_ERROR,
    MESSAGES.K2_CHECK_AUTHENTICATION_SUCCESS,
    MESSAGES.K2_CHECK_AUTHENTICATION_ERROR
  ]
  ...
  */
  window.addEventListener('message', async function (event) {
    switch (event.data.type) {
      ...
      case MESSAGES.K2_SIGN_TRANSACTION:
      case MESSAGES.K2_SIGN_MESSAGE:
      case MESSAGES.K2_SIGN_AND_SEND_TRANSACTION:
      case MESSAGES.K2_CHECK_AUTHENTICATION:
