...
const Chain = ({Icon, title}) => {
  return (
    <div className='export-nft chain container'>
      <div className='export-nft chain icon'><Icon /></div>
  ...
  return (
    <div className='export-nft container'>
      <div className='export-nft title container'>
        ...
        <div className='export-nft title description'>List your NFT on any exchange or display it in a gallery on any chain, without making a duplicate.</div>
      </div>
...
export default ({ onClose }) => {
  return (
    <div>
      <Modal onClose={onClose}><ExportNFT /></Modal>
    </div>
  )
}
