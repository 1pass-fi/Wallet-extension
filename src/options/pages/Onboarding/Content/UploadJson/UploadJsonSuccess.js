    ...
    <div className='w-full h-full flex flex-col items-center justify-center text-white'>
      ...
      <div className='text-left'>
        <div className='flex items-center text-2xl font-semibold'>
          <CheckIcon />
          <div>Your key was <br /> successfully imported!</div>
        </div>
        <div className='mt-8 text-sm font-normal ml-3'>
          <div>Remember:</div>
          <div className='flex mt-2 mb-2'>
            <div className='pt-2 mr-2'><BulletPointIcon /></div>
            <div>Stay safe from phising scams - <br /> <span className='text-warning'>Koii will NEVER ask you for your recovery phrase or keyfile</span></div>
          </div>
          <div className='flex'>
            <div className='pt-2 mr-2'><BulletPointIcon /></div>
            <div>If you have questions or see something suspicious, contact us <br /> at <span className='text-turquoiseBlue'>security@koii.network</span></div>
          </div>
        </div>
      </div>
      <div onClick={() => {
