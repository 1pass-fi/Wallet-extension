...
export default () => {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 3xl:grid-cols-6 4xl:grid-cols-7 5xl:grid-cols-8 gap-x-5 gap-y-3.75 place-items-center">
      {nfts.map((cardInfo) => (
